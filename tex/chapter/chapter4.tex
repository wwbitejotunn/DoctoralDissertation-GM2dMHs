...
在表\ref{tab:IS_ICOHP}中，我们列举了
\def\aColWidth{0.12\textwidth}
\def\bColWidth{0.2\textwidth}
\def\cColWidth{0.22\textwidth}
\def\dColWidth{0.12\textwidth}
\def\eColWidth{0.2\textwidth}
\begin{table}[htb]
    \label{tab:IS_ICOHP}
    \caption{-COHP值}
    \begin{tabular}{
        ...
        \midrule
        \multirow{2}{\aColWidth}{底部赝氢钝化切片模型\cemb{InSb}}&\cemb{Sb}极性&\cemb{In}(表面层)-\cemb{Sb}(块体)&2.91 &3.08\\
        \cmidrule(l){2-5}
        &\cemb{In}极性&\cemb{Sb}(表面层)-\cemb{In}(块体)&2.91 &3.17\\
        \midrule
        \multirow{7}{0.15\textwidth}{\cemb{Bi}衬底上单层\cemb{InSb}}&\multirow{2}{\bColWidth}{\cemb{Sb}极性}&\cemb{In}($\HthreeSite$)-\cemb{Bi}&3.57&0.81\\
        \cmidrule(l){3-5}
        ...
        \midrule
        \multirow{8}{\aColWidth}{\cemb{Bi}衬底上双层\cemb{InSb}}&\cemb{In}空位重构二层-\cemb{In}极性首层&\cemb{Sb}($\HthreeSite$)-Bi&3.42&0.85\\
        \cmidrule(l){2-5}
        &\cemb{Sb}三聚体重构二层-\cemb{In}极性首层&\cemb{Sb}($\HthreeSite$)-Bi&3.47&0.81\\
        \cmidrule(l){2-5}
