...
\begin{figure}[htb]
    ...
    \caption{非满覆盖二层生长的双层\cemb{InSb}的原子构型。(a)$\CNinNsb{1}{2}{0}{2}$，(b)$\CNinNsb{1}{2}{2}{0}$，(c)$\CNinNsb{3}{4}{0}{3}$，(d)$\CNinNsb{1}{1}{1}{2}$。}
...
\begin{figure}[htb]
    ...
    \caption{非满覆盖二层生长的双层\cemb{InSb}的原子构型。(a)$\CNinNsb{1}{4}{1}{0}$，(b)$\CNinNsb{3}{4}{2}{1}$。}
...
\begin{figure}[htb]
    ...
    \caption{赝氢饱和的\cemb{InSb}切片模型。(a)\cemb{In}极性上表面切片模型；(b)\cemb{Sb}三聚体重构上表面切片模型。}
...
\begin{figure}[htb]
    ...
    \caption{四面体法计算$\tmuVar{}{}$所使用的4个不同大小的\cemb{Sb}极性\cemb{InSb}四面体团簇。(a)大小为2的四面体团簇；(b)大小为3的四面体团簇；(c)大小为7的四面体团簇；(d)大小为8的四面体团簇。}
...
\begin{figure}[htb]
    ...
    \caption{第一层\cemb{InSb}结构为$\InSbMLpolar{2}{2}$条形时具有不同表面重构第二层的双层\cemb{InSb}的原子结构图。(a)\cemb{Sb}三聚体重构第二层；(b)\cemb{In}空位重构第二层。}
