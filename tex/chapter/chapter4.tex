...
为了测算原子之间的相互作用和化学键的强弱，本研究使用LOBSTER软件包对晶体轨道哈密顿量布居（Crystal Orbital Hamilton Population, COHP）进行了计算和分析\citing{RN951-2011, RN950-1993, RN949-2016}。在本章中，\cemb{InSb(111)/Bi(001)}体系中的成键强弱由-COHP谱和-COHP积分（-ICOHP）进行量化。-ICOHP由-COHP谱中的电子占据态积分而来。在-COHP和-ICOHP中，成键态以正值表示，反键态以负值表示。
